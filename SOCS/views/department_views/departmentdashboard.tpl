...
&nbsp;&nbsp;<a href='../index.php?action=departments'>Departments</a></div></center>           
   ...
   <form>
        ...
        <a href = "#">Checked All</a> / <a href = "#">Unchecked All</a> <input type="button" value="Add Department"></input><br>
        </center>
        ...
        <tr>
          ...
          <tr>
            ...
            <td><p>Institute of Computing</p></td>
        </tr>
        <tr>
            <td><input type="checkbox"></input></td>
            <td><p>College of Technology</p></td>
        </tr>
        <tr>
            <td><input type="checkbox"></input></td>
            <td><p>Engineering College</p></td>
        </tr>
