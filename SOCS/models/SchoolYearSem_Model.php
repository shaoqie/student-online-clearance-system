...
class SchoolYearSem_Model extends Model {
    ...
    public function getSchool_Year_by_id($id) {
        $this->query = mysql_query("SELECT School_Year FROM schoolyearsem WHERE SY_SEM_ID='$id'");
    ...
    public function getSem_by_id($id){
        $this->query = mysql_query("SELECT Semester FROM schoolyearsem WHERE SY_SEM_ID='$id'");
